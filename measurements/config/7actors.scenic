...
a6= Car in CircularRegion(ego, r).intersect(CircularRegion(a1, r)).intersect(CircularRegion(a2, r)).intersect(CircularRegion(a3, r)).intersect(CircularRegion(a4, r)).intersect(CircularRegion(a5, r)), \
    with color [50/256, 50/256, 50/256] # black
