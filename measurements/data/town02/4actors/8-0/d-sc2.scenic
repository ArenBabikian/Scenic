...
ego = Car in SectorRegion(o3, 20, o3.heading-(math.pi/2), math.atan(2.5/2)).intersect(SectorRegion(o1, 50, o1.heading, math.atan(2/5))), with color[0.734375, 0.72265625, 0.71484375]
o2 = Car in SectorRegion(ego, 50, ego.heading+math.pi, math.atan(2/5)).intersect(SectorRegion(o1, 50, o1.heading+math.pi, math.atan(2/5))).intersect(SectorRegion(o3, 50, o3.heading, math.atan(2/5))), with color[0.29296875, 0.46484375, 0.61328125]
