...
o2 = Car in SectorRegion(o3, 20, o3.heading+(math.pi/2), math.atan(2.5/2)), with color[0.29296875, 0.46484375, 0.61328125]
o4 = Car in SectorRegion(ego, 20, ego.heading-(math.pi/2), math.atan(2.5/2)).intersect(SectorRegion(o2, 50, o2.heading+math.pi, math.atan(2/5))), with color[0.265625, 0.625, 0.52734375]
o1 = Car in SectorRegion(ego, 20, ego.heading-(math.pi/2), math.atan(2.5/2)).intersect(SectorRegion(o4, 20, o4.heading-(math.pi/2), math.atan(2.5/2))).intersect(SectorRegion(o2, 50, o2.heading+math.pi, math.atan(2/5))), with color[0.7578125, 0.359375, 0.33203125]
